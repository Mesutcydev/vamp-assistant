...
**Install:** [download the latest Apple-silicon DMG](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.26/Vamp-Assistant-0.10.26-build-79.dmg) or [ZIP](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.26/Vamp-Assistant-0.10.26-build-79.zip), open it, and move **Vamp Assistant.app** to Applications. Apple Silicon + macOS 15+.
