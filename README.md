...
**Install:** [download the latest Apple-silicon ZIP](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.29/Vamp-Assistant-0.10.29-build-87.zip), open it, and move **Vamp Assistant.app** to Applications. Apple Silicon + macOS 15+.
