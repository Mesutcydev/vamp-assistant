...
[Download the latest unsigned iPhone/iPad IPA](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.36/Vamp-Assistant-iOS-0.10.36-build-111-unsigned.ipa)
...
**Install:** [download the latest Apple-silicon DMG](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.36/Vamp-Assistant-0.10.36-build-108-preview.dmg) or [ZIP](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.36/Vamp-Assistant-0.10.36-build-108-preview.zip), open it, and move **Vamp Assistant.app** to Applications. Apple Silicon + macOS 15+.
