...
**Install:** [download the latest Apple-silicon DMG](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.33/Vamp-Assistant-0.10.33-build-91-preview.dmg) or [ZIP](https://github.com/Mesutcydev/vamp-assistant/releases/download/v0.10.33/Vamp-Assistant-0.10.33-build-91-preview.zip), open it, and move **Vamp Assistant.app** to Applications. Apple Silicon + macOS 15+.
